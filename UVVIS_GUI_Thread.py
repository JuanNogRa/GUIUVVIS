...
from UVVIS_Logic import ShowImageOnInterface, ShowDepthMap
import sys
...
"}")
        ...
        self.Disparidad_Calculate = QtWidgets.QPushButton(self.formLayoutWidget_4)
        self.Disparidad_Calculate.setStyleSheet("QPushButton {\n"
"    color:white;\n"
"    border:1px solid rgb(51,51,51);    \n"
"    border-radius:4px;\n"
"    background-color: rgba(0,0,0,0);\n"
...
"    background-color: rgba(0,0,0,0);\n"
"}")
        self.Disparidad_Calculate.setObjectName("Disparidad_Calculate")
        self.horizontalLayout_24.addWidget(self.Disparidad_Calculate)
...
"}")
        ...
        self.pushButton_3.clicked.connect(lambda: self.CancelFeed())
        ...
        self.Disparidad_Calculate.clicked.connect(lambda: self.showmapadisparidad())
    ...
    def ActivateCamera(self):
        self.ShowImageOnInterface = ShowImageOnInterface("")
    ...
    def RectificactionCamera(self):
        self.ShowImageOnInterface = ShowImageOnInterface(self.path)
        self.ShowImageOnInterface.start()
        self.ShowImageOnInterface.ImageUpdate.connect(self.ImageUpdateSlot)
        self.ShowImageOnInterface.ImageUpdate1.connect(self.ImageUpdateSlot1)   
        self.ShowImageOnInterface.Update_left_rect.connect(self.ImageUpdateLeftRect)  
        self.ShowImageOnInterface.Update_right_rect.connect(self.ImageUpdateRightRect)   
...
"todo a través de esta interfaz gráfica de usuario."))
        ...
        self.Disparidad_Calculate.setText(_translate("MainWindow", "Mapa de\n"
"Disparidad"))
...
"prueba"))
        self.groupBox_9.setTitle(_translate("MainWindow", "Configuración de dispositivos de sonido"))
