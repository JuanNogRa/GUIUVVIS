...
"}")
        ...
        self.formLayoutWidget_4.setGeometry(QtCore.QRect(10, 250, 207, 46))
...
"}")
    ...
    def showimage(self):
    #This function will load the camera device, and show image on leftcamera and right_camera
    		
    #Imprimir imagen en GUI
    # Open the ZED camera
